...
class PriceConverter {
  ...
  static String convertPrice(double? price,
    ...
    bool _isRightSide = Get.find<SplashController>()
                .configModel
                .content
  ...
  static Discount _getDiscount(List<ServiceDiscount>? serviceDiscountList,
    ...
    ServiceDiscount? serviceDiscount =
        (serviceDiscountList != null && serviceDiscountList.length > 0)
            ? serviceDiscountList.first
            : null;
    if (serviceDiscount != null) {
      num? _getDiscount = serviceDiscount.discount?.discountAmount;
      if (_getDiscount! > serviceDiscount.discount!.maxDiscountAmount! &&
  ...
  static Discount discountCalculation(Service service,
    ...
    if (service.serviceDiscount != null &&
      ...
      Discount _discount = _getDiscount(
          service.serviceDiscount, _discountAmount, _discountAmountType);
      ...
      _discountAmountType = _discount.discountAmountType;
        ...
        addCampaign) {
      Discount _discount = _getDiscount(
          service.campaignDiscount, _discountAmount, _discountAmountType);
      _discountAmount = _discount.discountAmount;
      _discountAmountType = _discount.discountAmountType;
    } else {
      if (service.category?.categoryDiscount != null &&
          service.category!.categoryDiscount!.isNotEmpty) {
        Discount _discount = _getDiscount(service.category?.categoryDiscount,
        ...
        _discountAmountType = _discount.discountAmountType;
          ...
          addCampaign) {
        Discount _discount = _getDiscount(service.category?.campaignDiscount,
            _discountAmount, _discountAmountType);
        _discountAmount = _discount.discountAmount;
        _discountAmountType = _discount.discountAmountType;
      }
