import 'package:repair/core/push_notification_dialog.dart';
   ...
   // var iOSInitialize = new IOSInitializationSettings();
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      if (ResponsiveHelper.isWeb()) {
        if (!Get.currentRoute.contains('/checkout?currentPage=complete')) {
      ...
      try {
        if (message.notification!.titleLocKey != null &&
          ...
          Get.toNamed(RouteHelper.getBookingDetailsScreen(
              message.notification!.titleLocKey!, 'fromNotification'));
        } else {
          Get.toNamed(RouteHelper.getNotificationRoute());
        }
      } catch (e) {}
