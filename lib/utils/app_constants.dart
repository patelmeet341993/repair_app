import 'package:repair/data/model/choose_us_model.dart';
import 'package:repair/data/model/response/language_model.dart';
...
class AppConstants {
  ...
  static const String COMPANY_LIST =
      '/api/v1/customer/provider?limit=20&offset=1';
  ...
  static const String COUPON_URI =
      '/api/v1/customer/coupon?limit=100&offset=1&status=all&coupon_type=all';
