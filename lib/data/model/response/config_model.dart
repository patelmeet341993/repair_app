...
class Content {
  ...
  Content.fromJson(Map<String, dynamic> json) {
    ...
    appleSocialLogin = json['facebook_social_login'] != null ? json['facebook_social_login'] : null; ///will be provide by 28/01
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['facebook_social_login'] = this.appleSocialLogin;
