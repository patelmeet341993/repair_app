...
import 'package:repair/controller/localization_controller.dart';
import 'package:repair/data/model/response/config_model.dart';
import 'package:repair/feature/location/widget/registration_card.dart';
...
import 'package:repair/feature/web_landing/model/web_landing_model.dart';
import 'package:repair/feature/web_landing/repository/web_landing_repo.dart';
import 'package:repair/feature/web_landing/widget/live_chat_button.dart';
import 'package:repair/feature/web_landing/widget/web_landing_search_box.dart';
import 'package:repair/feature/web_landing/widget/web_landing_shimmer.dart';
import 'package:repair/feature/web_landing/widget/web_mid_section.dart';
    ...
    return GetBuilder<WebLandingController>(
      ...
      builder: (webLandingController) {
        if (webLandingController.webLandingContent != null) {
          var textContent = Map.fromIterable(
              webLandingController.webLandingContent!.textContent!,
              key: (e) => e.keyName,
              value: (e) => e.liveValues);
          var imageContent = Map.fromIterable(
              webLandingController.webLandingContent!.imageContent!,
              key: (e) => e.keyName,
              value: (e) => e.liveValues);
                      ...
                      child: SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            CustomImage(
                              height:
                                  Dimensions.WEB_LANDING_DOWNLOAD_IMAGE_HEIGHT,
                              width:
                                  Dimensions.WEB_LANDING_DOWNLOAD_IMAGE_HEIGHT,
                              image:
                                  "$baseUrl/landing-page/web/${imageContent['download_section_image']}",
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: CustomImage(
                            ...
                            fit: BoxFit.cover,
                            width: Dimensions.SUPPORT_LOGO_WIDTH,
                            height: Dimensions.SUPPORT_LOGO_HEIGHT,
                          ),
                        ),
                      ],
                    ),
