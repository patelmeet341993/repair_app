...
import 'package:repair/feature/html/controller/webview_controller.dart';
          ...
          title: htmlType == HtmlType.TERMS_AND_CONDITION
              ...
              : htmlType == HtmlType.ABOUT_US
                  ...
                  : htmlType == HtmlType.PRIVACY_POLICY
                      ? 'privacy_policy'.tr
                      : htmlType == HtmlType.CANCELLATION_POLICY
                          ? 'cancellation_policy'.tr
                          : htmlType == HtmlType.REFUND_POLICY
                              ? 'refund_policy'.tr
                              : 'no_data_found'.tr),
      body: GetBuilder<HtmlViewController>(
        ...
        builder: (htmlViewController) {
          ...
          if (htmlViewController.pagesContent != null) {
            _data = htmlType == HtmlType.TERMS_AND_CONDITION
                ? htmlViewController
