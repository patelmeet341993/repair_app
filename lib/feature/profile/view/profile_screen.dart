...
import 'package:repair/feature/profile/model/profile_cart_item_model.dart';
    ...
    final _profileCartModelList = [
      ProfileCardItemModel(
        ...
        Get.find<AuthController>().isLoggedIn()
            ...
            : RouteHelper.getNotLoggedScreen('my_address'.tr),
      ),
      ProfileCardItemModel(
        'notifications'.tr,
        Images.notification,
      ...
      if (!Get.find<AuthController>().isLoggedIn())
        ProfileCardItemModel(
          'sign_in'.tr,
          Images.logout,
          RouteHelper.getSignInRoute('profileScreen'),
        ),
      if (Get.find<AuthController>().isLoggedIn())
        ProfileCardItemModel(
          'logout'.tr,
                        ...
                        GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ProfileCardItem(
                              ...
                              leadingIcon:
                                  _profileCartModelList[index].loadingIcon,
                              onTap: () {
                                if (_profileCartModelList[index].routeName ==
                                    'sign_out') {
                                  if (Get.find<AuthController>().isLoggedIn()) {
                                    Get.dialog(
                                        ConfirmationDialog(
                                ...
                                } else if (_profileCartModelList[index]
                                        .routeName ==
                                    'delete_account') {
                                  Get.dialog(
                                      ConfirmationDialog(
                                  ...
                                  Get.toNamed(
                                      _profileCartModelList[index].routeName);
                                }
                              },
                            );
                          },
