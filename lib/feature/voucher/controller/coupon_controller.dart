...
class ProductCouponController extends GetxController implements GetxService{
  final ProductCouponRepo couponRepo;
  ProductCouponController({required this.couponRepo});
