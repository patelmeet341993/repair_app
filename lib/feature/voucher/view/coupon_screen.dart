...
class ProductCouponScreen extends StatefulWidget {
  const ProductCouponScreen({Key? key}) : super(key: key);

  @override
  State<ProductCouponScreen> createState() => _ProductCouponScreenState();
}

class _ProductCouponScreenState extends State<ProductCouponScreen>
    with TickerProviderStateMixin {
  TabController? _couponTabController;
