...
class ShopWebPopularServiceView extends StatelessWidget {
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    itemCount:
                        _serviceList!.length > 7 ? 8 : _serviceList.length,
                        ...
                        onTap: () {
                          ...
                          Get.toNamed(
                            RouteHelper.getServiceRoute(
                                _serviceList[index].id!),
                            arguments: ServiceDetailsScreen(
                                serviceID: _serviceList[index].id!),
                          );
                        },
                        child: Container(
                          padding:
                              EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL - 2),
                                ...
                                child: Stack(
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: CustomImage(
                                          image:
                                              '${Get.find<SplashController>().configModel.content!.imageBaseUrl!}/service/${_serviceList[index].thumbnail}',
                                          fit: BoxFit.cover,
                                          width: double.maxFinite),
                                    ),
                                    if (_discount.discountAmount != null &&
                                        _discount.discountAmountType != null &&
                            ...
                            Expanded(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    RatingBar(
                                      rating: double.parse(_serviceList[index]
                                          .avgRating
                                          .toString()),
                                      size: 15,
                                      ratingCount:
                                          _serviceList[index].ratingCount,
                                    ),
                                    SizedBox(
                                        height: Dimensions
                                            .PADDING_SIZE_EXTRA_SMALL),
                                          ...
                                          Expanded(
                                            ...
                                            child: Text(
                                              PriceConverter.convertPrice(
                                                double.parse(_serviceList[index]
                                                    .variationsAppFormat!
                                                    .defaultPrice
                                                    .toString()),
                                                discount: 2.0,
