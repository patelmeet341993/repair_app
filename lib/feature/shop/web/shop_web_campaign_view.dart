...
import 'package:repair/feature/home/web/web_banner_shimmer.dart';
import 'package:get/get.dart';

class ShopWebCampaignView extends GetView<BannerController> {
  @override
                    ...
                    ? campaignController.campaignList!.length == 1
                        ? InkWell(
                            ...
                            child: ClipRRect(
                              ...
                              child: CustomImage(
                                image:
                                    '${Get.find<SplashController>().configModel.content!.imageBaseUrl}/campaign/${campaignController.campaignList![0].coverImage}',
                                fit: BoxFit.fill,
                                height: 220,
                              ),
                            ),
                                  ...
                                  return Row(children: [
                                    Expanded(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: CustomImage(
                                          image:
                                              '$_baseUrl/campaign/${campaignController.campaignList![index1].coverImage}',
                                          fit: BoxFit.cover,
                                          height: 220,
                                        ),
                                      ),
                                        ...
                                        child: _hasSecond
                                            ? InkWell(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: CustomImage(
                                                    image:
                                                        '$_baseUrl/campaign/${campaignController.campaignList![index2].coverImage}',
                                                    fit: BoxFit.cover,
                                                    height: 220,
                                                  ),
                                                ),
                                            ...
                                            : (!_hasSecond &&
                                                ...
                                                ? InkWell(
                                                    ...
                                                    child: ClipRRect(
                                                      ...
                                                      child: CustomImage(
                                                        image:
                                                            '$_baseUrl/campaign/${campaignController.campaignList![0].coverImage}',
                                                        fit: BoxFit.cover,
                                                        height: 220,
                                                      ),
                                                    ),
