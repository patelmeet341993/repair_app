class ShopBannerContentModel {
  int? _currentPage;
  List<ShopBannerModel>? _data;
  String? _firstPageUrl;
  int? _from;
  int? _lastPage;
  String? _lastPageUrl;
  List<ShopLinks>? _links;
  String? _path;
  String? _perPage;
  int? _to;
  int? _total;

  ShopBannerContentModel(
      {int? currentPage,
        List<ShopBannerModel>? data,
        String? firstPageUrl,
        int? from,
        int? lastPage,
        String? lastPageUrl,
  ...
  List<ShopBannerModel>? get data => _data;
  String? get firstPageUrl => _firstPageUrl;
  int? get from => _from;
  int? get lastPage => _lastPage;
  String? get lastPageUrl => _lastPageUrl;
  List<ShopLinks>? get links => _links;
  String? get path => _path;
  String? get perPage => _perPage;
  int? get to => _to;
  int? get total => _total;

  ShopBannerContentModel.fromJson(Map<String, dynamic> json) {
    _currentPage = json['current_page'];
    if (json['data'] != null) {
      _data = <ShopBannerModel>[];
      json['data'].forEach((v) {
        _data!.add(new ShopBannerModel.fromJson(v));
      });
    }
    ...
    if (json['links'] != null) {
      ...
      json['links'].forEach((v) {
        _links!.add(new ShopLinks.fromJson(v));
      });
    }
    _path = json['path'];
...
class ShopBannerModel {
  ...
  ShopBannerModel.fromJson(Map<String, dynamic> json) {
    ...
    _service =
    json['service'] != null ? new ShopService.fromJson(json['service']) : null;
    _category = json['category'] != null
        ? new ShopCategory.fromJson(json['category'])
        : null;
  }
...
class ShopLinks {
  ...
  ShopLinks({String? url, String? label, bool? active}) {
    if (url != null) {
      this._url = url;
    }
    if (label != null) {
