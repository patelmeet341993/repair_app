...
class ProductDetailsReview extends StatefulWidget {
  ...
  @override
  State<ProductDetailsReview> createState() => _ProductDetailsReviewState();
}

class _ProductDetailsReviewState extends State<ProductDetailsReview> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < widget.reviewList.length; i++) {
      if (widget.reviewList[i].reviewComment != null &&
          widget.reviewList[i].reviewComment != 'a') {
        reviewCount++;
      }
    }
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            RatingBar(
                                rating:
                                    double.parse('${rating.averageRating}')),
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ServiceReviewItem(
                            reviewData: widget.reviewList.elementAt(index),
                          );
                        }),
                  ],
                ),
