class ProductCouponModel {
  ...
  ProductCouponModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class CouponProductDiscount {
  ...
  CouponProductDiscount.fromJson(Map<String, dynamic> json) {
    id = json['id'];
