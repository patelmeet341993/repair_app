...
import 'package:repair/feature/shop/repository/shop_campaign_repo.dart';

import '../../shop/controller/shop_banner_controller.dart';
import '../../shop/controller/shop_campaign_controller.dart';
...
class BottomNavBinding extends Bindings {
  ...
  void dependencies() async {
    ...
    Get.lazyPut(() => ShopCampaignController(shopCampaignRepo: ShopCampaignRepo(apiClient: Get.find())));
