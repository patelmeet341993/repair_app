...
class SplashRepo {
  ...
  Future<bool> setSplashSeen(bool isSplashSeen) async {
    return await sharedPreferences.setBool(
        AppConstants.IS_SPLASH_SEEN, isSplashSeen);
  }

  bool isSplashSeen() {
    return sharedPreferences.getBool(AppConstants.IS_SPLASH_SEEN) != null
        ? sharedPreferences.getBool(AppConstants.IS_SPLASH_SEEN)!
        : false;
  }
