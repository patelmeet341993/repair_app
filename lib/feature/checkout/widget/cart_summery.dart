          ...
          builder: (cartController) {
            ...
            return Column(
              children: [
                ...
                Container(
                  decoration: BoxDecoration(color: Theme.of(context).cardColor, boxShadow: Get.isDarkMode ? null : shadow),
                  child: Padding(
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: ubuntuMedium.copyWith(
                                        color: Theme.of(context).textTheme.bodyText1!.color!.withOpacity(.4), fontSize: Dimensions.fontSizeSmall),
                                    maxLines: 2,
                ...
                child: Column(
                  children: [
                    ListView.builder(
                      ...
                      physics: NeverScrollableScrollPhysics(),
                      itemBuilder: (context, index) {
                        double totalCost = cartList.elementAt(index).price.toDouble() * cartList.elementAt(index).quantity;
                        return Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            RowText(title: cartList.elementAt(index).productName, quantity: cartList.elementAt(index).quantity, price: totalCost),
                            Container(
                              width: Get.width / 2.5,
                              child: Text(
