...
import 'package:repair/feature/checkout/widget/custom_header_icon_section.dart';
import 'package:repair/feature/checkout/widget/custom_header_line.dart';
import 'package:repair/feature/checkout/widget/custom_text.dart';
import 'package:repair/feature/checkout/widget/order_complete_section/complete_page.dart';
        ...
        appBar: CustomAppBar(
            ...
            onBackPressed: () {
              if (widget.pageState == 'payment' || Get.find<CheckOutController>().currentPage == PageState.payment) {
                ...
                if (ResponsiveHelper.isWeb()) Get.toNamed(RouteHelper.getCheckoutRoute('cart', 'orderDetails', 'null'));
              } else {
                Get.back();
              }
            }),
                                            ...
                                            children: [
                                              ...
                                              controller.currentPage == PageState.orderDetails
                                                  ? const CustomHeaderLine(
                                                      color: Color(0xffFF833D), gradientColor1: Color(0xffFDA21A), gradientColor2: Colors.orangeAccent)
                                              ...
                                              controller.cancelPayment
                                                  ? const CustomHeaderLine(cancelOrder: true, gradientColor1: Colors.grey, gradientColor2: Colors.grey)
                                                  : controller.currentPage == PageState.payment
                                                      ? const CustomHeaderLine(
                                                          color: Colors.green, gradientColor1: Colors.orangeAccent, gradientColor2: Colors.green)
                                              ...
                                              CustomHeaderIcon(
                                                ...
                                                isActiveColor: controller.currentPage == PageState.complete ? true : false,
                                              ),
                                            ],
                                          ),
                                        ),
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: CustomText(
                                                text: "payment".tr,
                                                isActive: controller.currentPage == PageState.payment || PageState.payment.name == widget.pageState),
                                          ),
                                          CustomText(
                                              text: "complete".tr, isActive: controller.currentPage == PageState.complete || widget.pageState == 'complete'),
                                        ],
                                      ),
                                    ),
                                  ),
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      'back_to_homepage'.tr,
                                      style: ubuntuMedium.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeDefault),
                                    ),
                                  ),
                                ),
                              );
                                          ...
                                          if (controller.selectedPaymentMethod != PaymentMethodName.digitalPayment) {
                                            ...
                                            if (!Get.find<ScheduleController>().checkScheduleTime()) {
                                              customSnackBar('set_your_schedule_time'.tr);
                                                ...
                                                ? false
                                                : addressModel == null || addressModel.contactPersonNumber == "null") {
                                              ...
                                              if (controller.currentPage == PageState.orderDetails && PageState.orderDetails.name == widget.pageState) {
                                                ...
                                                if (addressList.length > 0) {
                                                  ...
                                                  ///navigate replace
                                                  Get.toNamed(RouteHelper.getCheckoutRoute('cart', Get.find<CheckOutController>().currentPage.name,
                                                      widget.pageState == 'payment' ? widget.addressId : addressModel!.id.toString()));
                                                } else {}
                          ...
                          GetBuilder<AuthController>(builder: (authController) {
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                width: Get.width,
                                decoration:
                                    BoxDecoration(color: authController.acceptTerms ? Theme.of(context).colorScheme.primary : Theme.of(context).disabledColor),
                                child: Center(
                                  child: Text(
                                    'proceed_to_checkout'.tr,
