      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: fromCheckout &&
                    Get.find<LocationController>().selectedAddress?.id ==
                        address.id
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(
                                  "${address.addressLabel != null ? address.addressLabel.toString().toLowerCase() : 'others'}"
                                      .tr,
                                  style: ubuntuMedium.copyWith(fontSize: 16)),
                            ],
                          ),
                          SizedBox(
