...
import 'package:repair/feature/conversation/widgets/chatting_shimmer.dart';
import 'package:repair/feature/conversation/widgets/message_widget.dart';
              ...
              return Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      '${DateConverter.dateMonthYearTimeTwentyFourFormat(DateConverter.isoUtcStringToLocalDate(widget.date))}',
                      style: ubuntuMedium.copyWith(
                          fontSize: Dimensions.fontSizeSmall,
                          color: Theme.of(context)
                              .textTheme
