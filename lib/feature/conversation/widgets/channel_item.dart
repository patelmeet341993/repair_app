...
import 'package:repair/feature/conversation/model/conversation_user.dart';
...
class ChannelItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (conversationUserModel.user!.provider != null) {
      ...
      name = conversationUserModel.user!.firstName! +
          " " +
          conversationUserModel.user!.lastName!;
      image =
          '${Get.find<SplashController>().configModel.content!.imageBaseUrl}'
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                            "${DateConverter.dateMonthYearTimeTwentyFourFormat(DateConverter.isoUtcStringToLocalDate(channelupdatedAt))}",
