...
class AuthRepo {
  ...
  Future<Response?> updateToken() async {
    ...
    print(_deviceToken);
    return await apiClient.postData(
        AppConstants.TOKEN_URI, {"_method": "put", "fcm_token": _deviceToken});
  }
  ...
  Future<Response?> forgetPassword(String? phone) async {
    return await apiClient
        .postData(AppConstants.FORGET_PASSWORD_URI, {"phone_or_email": phone});
  }
  ...
  Future<bool?> saveUserToken(String token) async {
    ...
    apiClient.updateHeader(
        token,
        sharedPreferences.getString(AppConstants.USER_ADDRESS) != null
  ...
  bool clearSharedData() {
    if (!GetPlatform.isWeb) {
      ...
      apiClient.postData(
          AppConstants.TOKEN_URI, {"_method": "put", "fcm_token": '@'});
    }
