...
import 'package:repair/components/web_search_widget.dart';
    ...
    return Center(
      ...
      child: Row(children: [
        InkWell(
          ...
          child: Image.asset(
              Get.isDarkMode ? Images.webAppbarLogoDark : Images.webAppbarLogo,
              width: 150),
        ),
        ...
        MenuButtonWeb(
            title: 'services'.tr,
            onTap: () =>
                Get.toNamed(RouteHelper.allServiceScreenRoute('allServices'))),
