...
import 'package:repair/components/text_hover.dart';
                  ...
                  Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                          GetBuilder<WebLandingController>(initState: (_) {
                            Get.find<WebLandingController>()
                                .getWebLandingContent();
                          }, builder: (weblandingController) {
                            if (weblandingController.socialMedia != null &&
                                weblandingController.socialMedia!.length > 0) {
                              List<SocialMedia>? _socialMediaList =
                                  Get.find<WebLandingController>().socialMedia;
                              return Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        if (_socialMediaList![index].media ==
                                            'facebook') {
                                          icon = Images.facebookIcon;
                                        } else if (_socialMediaList[index]
                                                .media ==
                                            'linkedin') {
                                      ...
                                      itemCount: _socialMediaList != null
                                          ? _socialMediaList.length
                                          : 0,
                                    ),
                                  ),
                                  SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FooterButton(
                              ...
                              url: true,
                              route:
                                  '${AppConstants.BASE_URL}/provider/auth/sign-up'),
                          const SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                        ],
                      )),
                ],
